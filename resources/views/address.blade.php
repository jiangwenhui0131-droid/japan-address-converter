...
<script>
    ...
    const translations = {
        ...
        ja: {
            ...
            csvFormatText:
                '最大10件まで変換できます。1列目に郵便番号、2列目に住所を入力してください。',
            ...
            guide4Answer:
                'はい。CSVファイルをアップロードして、最大10件の住所をまとめて変換できます。',
        ...
        en: {
            ...
            csvFormatText:
                'Up to 10 addresses can be converted. Enter the postal code in the first column and the address in the second column.',
            ...
            guide4Answer:
                'Yes. Upload a CSV file to convert up to 10 addresses at once.',
        ...
        ko: {
            ...
            csvFormatText:
                '최대 10개의 주소를 변환할 수 있습니다. 첫 번째 열에 우편번호, 두 번째 열에 주소를 입력하세요.',
            ...
            guide4Answer:
                '네. CSV 파일을 업로드하면 최대 10개의 주소를 한 번에 변환할 수 있습니다.',
        ...
        vi: {
            ...
            csvFormatText:
                'Có thể chuyển đổi tối đa 10 địa chỉ. Nhập mã bưu điện ở cột đầu tiên và địa chỉ ở cột thứ hai.',
            ...
            guide4Answer:
                'Có. Tải tệp CSV lên để chuyển đổi tối đa 10 địa chỉ cùng lúc.',
